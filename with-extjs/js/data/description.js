Ext.define('js.data.description', {
    ...
    content:{
            ...
            middle:{
                closeMe: `Done reading me? Close me by clicking the X in the top right corner.
    ...
    includePTag: function(side){
        const {north, west:{navigation, settings, information}, middle:{closeMe, centerPanel}, east:{aTab}, south} = this.content;
        let description
