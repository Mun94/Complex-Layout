Ext.define('js.data.description', {
    ...
    content:{
            ...
            middle:{
                closeMe: `<b>Done reading me? Close me by clicking the X in the top right corner</b>.
                ...
                centerPanel: `My closable attribute is set to false so you can't close me. The other center panels can be closed.
                The center panel automatically grows to fit the remaining space in the container that isn't taken up by the border regions.<hr>
            ...
            east: {
                aTab: 'A TabPanel component can be a region.',
                rowValue: {
            ...
            south: 'south - generally for informational stuff, also could be for status bar'
    },
    includePTag: function(side){
        const {
            north, 
